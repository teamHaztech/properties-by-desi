        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('leads.pipeline')" :active="request()->routeIs('leads.pipeline')">
                        Pipeline
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 sm:gap-4">
                <a href="{{ route('leads.quick-create') }}" class="inline-flex items-center px-3 py-1.5 bg-indigo-600 text-white text-sm font-medium rounded-md hover:bg-indigo-700 transition">
                    + Quick Lead
                </a>

                {{-- Notification Bell --}}
                <a href="{{ route('notifications.index') }}" class="relative p-2 text-gray-500 hover:text-gray-700 transition">
