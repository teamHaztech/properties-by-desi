                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                            <div>
                                ...
                                <input type="number" name="price" id="price" value="{{ old('price', $property->price) }}" required step="0.01"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                @error('price') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
                            </div>
                            <div>
                                <label for="price_per_sqm" class="block text-sm font-medium text-gray-700">Price / sq.m</label>
                                <input type="number" name="price_per_sqm" id="price_per_sqm" value="{{ old('price_per_sqm', $property->price_per_sqm) }}" step="0.01"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            ...
                            <div>
                                ...
                                <input type="number" name="size_sqm" id="size_sqm" value="{{ old('size_sqm', $property->size_sqm) }}" step="0.01"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="tags" id="tags"
                                       value="{{ old('tags', is_array($property->tags) ? implode(', ', $property->tags) : $property->tags) }}"
