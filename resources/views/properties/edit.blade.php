<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold leading-tight text-gray-800">Edit Property: {{ $property->title }}</h2>
            <a href="{{ route('properties.show', $property) }}" class="text-sm text-indigo-600 hover:text-indigo-500">&larr; Back to Property</a>
        </div>
    </x-slot>
    ...
    <div class="py-6">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('properties.update', $property) }}" x-data="{
                type: '{{ old('type', $property->type->value) }}',
                city_id: '{{ old('city_id', $property->city_id) }}',
                location: '{{ old('location', $property->location) }}',

                size_sqm: {{ old('size_sqm', $property->size_sqm ?? 0) ?: 0 }},
                price_per_sqm: {{ old('price_per_sqm', $property->price_per_sqm ?? 0) ?: 0 }},
                owner_expected_price: {{ old('owner_expected_price', $property->owner_expected_price ?? 0) ?: 0 }},
                commission_percent: {{ old('commission_percent', $property->commission_percent ?? 2) ?: 2 }},
                is_negotiable: {{ old('is_negotiable', $property->is_negotiable) ? 'true' : 'false' }},
                negotiable_price: {{ old('negotiable_price', $property->negotiable_price ?? 0) ?: 0 }},
                    ...
                    <div class="space-y-5">
                            ...
                            <div x-show="showSubType" x-transition x-cloak>
                                ...
                                <select name="sub_type" id="sub_type"
                                    ...
                                    @foreach($subTypes as $st)
                                        <option value="{{ $st->value }}" @selected(old('sub_type', $property->sub_type?->value) == $st->value)>{{ $st->label() }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" name="area" id="area" value="{{ old('area', $property->area) }}"
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" name="size_label" id="size_label" value="{{ old('size_label', $property->size_label) }}"
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4"
                                      ...
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('description', $property->description) }}</textarea>
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="tags" id="tags"
                                       value="{{ old('tags', $property->tags ? implode(', ', $property->tags) : '') }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="amenities" id="amenities"
                                       value="{{ old('amenities', $property->amenities ? implode(', ', $property->amenities) : '') }}"
                        ...
                        <div>
                            ...
                            <input type="url" name="map_link" id="map_link" value="{{ old('map_link', $property->map_link) }}"
                ...
                <div class="mt-6 rounded-lg bg-white p-6 shadow">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="owner_phone" id="owner_phone" value="{{ old('owner_phone', $property->owner_phone) }}"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
